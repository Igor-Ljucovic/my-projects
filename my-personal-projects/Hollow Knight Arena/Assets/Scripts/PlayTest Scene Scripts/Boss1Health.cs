...
public class Boss1Health : MonoBehaviour
{
    ...
    public void LowerEnemyHealthAndStaggerCheck(Transform playerAttack, int playerDamage)
    {
        ...
        if (boss1Behavior.isStaggered && boss1Behavior.currentBossStunDuration <= Boss1Behavior.Stagger.totalDuration - Boss1Behavior.Stagger.startingFramesThatDontEndStaggerIfAttacked)
